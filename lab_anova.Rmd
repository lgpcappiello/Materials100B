...
various feed supplements on chicken weights. 
...
-   Assume the assumptions are satisfied. Conduct the ANOVA for these data. Make
sure to report your results with a plain language explanation in the context of 
the study. 
