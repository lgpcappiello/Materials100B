...
*Solution* (1pt) : We would want to use a scatterplot for this.
```{r}
plot(mlb11$runs, mlb11$at_bats)
```
The relationship does look somewhat linear. We could probably use a linear regression on these data and make reasonable predictions.
*End solution*
...
*Solution* (1 pt):
There is be a relatively weak positive linear relationship. It is difficult to tell based on the scatterplot whether there are unusual observations.
*End solution*
